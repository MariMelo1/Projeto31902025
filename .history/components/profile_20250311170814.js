...
export default function Profile(){
    return(
        <View style={styles.containerProfile} >
            ...
            <Image source={{uri:'https://s2.glbimg.com/uYsIYy-rQgaW-2hI52R0mZ1cQMc=/620x455/e.glbimg.com/og/ed/f/original/2022/10/03/girassol-e-flor-entenda-casa-e-jardim.jpg'}} />
